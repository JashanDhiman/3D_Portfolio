 ...
 return (
  <>
   ...
   <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
    I'm a skilled software developer with experience in TypeScript and JavaScript, and expertise in technologies like React, Node.js, Postgres, and MongoDB. I seek for new things to learn and collaborate closely with
