...
const services = [
    ...
    {
        title: "Shopify Custom Apps Developer",
        icon: mobile,
    },
    {
...
const experiences = [
    ...
    },
    {
        ...
        points: [
            "Developing and maintaining Medical Platforms using React.js and integrated other third technologies such as Zoom SDK.",
            "Collaborating with cross-functional teams including designers, project managers, and other developers to create high-quality Medical platforms.",
