...
const projects = [
  ...
  },
  {
    name: "Wellness App",
    description:
      "Python Application that helps users to calculate there basic fitness metrics and diet related metrics. Also provides wellness related information such as yoga, exercises.",
    tags: [
      {
        name: "django",
        color: "blue-text-gradient",
